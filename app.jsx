    ...
    return(
        <nav className="px-0 py-4 sticky top-0 left-auto z-50  w-full bg-[#003338]">
            <div className="flex justify-between items-center w-full">
                ...
                <div className={`w-[105%]  md:w-fit h-[50vh] md:h-fit  flex flex-col p-4 md:p-0 absolute top-[100%] -right-[2.5%] md:relative md:flex-row md:top-0 md:right-0 gap-3 items-center items-center justify-center bg-[#003338] ${icon === 'menu' ? 'invisible' : 'visible'} md:visible transition-all duration-300 `}>
